export class TailwindClassHelper {
    ...
    static whiteColorFilterClass= '[filter:brightness(101%)_saturate(0%)_invert(100%)_sepia(0%)_saturate(0%)_hue-rotate(353deg)_brightness(101%)_contrast(104%)]';
    ...
    static outlineButtonBaseClass = 'border border-solid border-gray-300 dark:border-gray-100 enabled:text-gray-800 dark:enabled:text-gray-100 enabled:hover:border-primary-500 enabled:hover:bg-primary-50 dark:enabled:hover:bg-gray-800 group';
