<template>
    ...
    >
        <div
            v-if="open"
            class="fixed inset-0 z-20 bg-gray-950 dark:bg-gray-800 blur-xl bg-opacity-60 dark:bg-opacity-90 flex justify-center p-6"
    ...
    >
        <div
            v-if="open"
            class="fixed top-0 right-0 z-20 p-6 h-full bg-white dark:bg-gray-950 shadow-lg translate-none"
